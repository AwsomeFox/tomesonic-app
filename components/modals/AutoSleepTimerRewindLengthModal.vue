      ...
      <div class="w-full overflow-x-hidden overflow-y-auto bg-surface-container-high rounded-3xl border border-outline-variant border-opacity-40 shadow-elevation-4" style="max-height: 75%">
        ...
        <div class="px-6 pt-5 pb-3">
          <div class="w-full flex items-center">
            <span class="material-symbols text-on-surface mr-3" style="font-size: 24px">replay</span>
            <h2 class="text-headline-small text-on-surface font-medium capitalize flex-grow">{{ $strings.LabelAutoRewindTime }}</h2>
          </div>
        </div>
