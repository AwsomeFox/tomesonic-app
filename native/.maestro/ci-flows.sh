#!/usr/bin/env bash
# CI entrypoint for the Maestro suite (rev 4) — invoked as a SINGLE line from
...
# foliate-js is now vendored (utils/foliateBundle.ts) — the reader renders
# offline, so this flow is a normal blocking part of the gate again.
