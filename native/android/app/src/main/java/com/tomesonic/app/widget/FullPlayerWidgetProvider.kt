...
class FullPlayerWidgetProvider : AppWidgetProvider() {
    ...
    private fun updateWidget(context: Context, mgr: AppWidgetManager, id: Int) {
        ...
        views.setOnClickPendingIntent(R.id.full_chapter_prev, actionPI(context, 4, "com.tomesonic.app.WIDGET_CHAPTER_PREV"))
        views.setOnClickPendingIntent(R.id.full_chapter_next, actionPI(context, 5, "com.tomesonic.app.WIDGET_CHAPTER_NEXT"))
