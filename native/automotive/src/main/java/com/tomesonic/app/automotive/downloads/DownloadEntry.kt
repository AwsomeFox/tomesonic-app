...
// is read by the phone's native Android Auto browse service to play downloads
// with JS asleep, which is exactly what this one does for the car's offline
// SessionManager.
//
 ...
 * has under `filesDir/downloads/{entryId}/`, derived by
 * [com.tomesonic.app.automotive.data.AudioTrack] for a book and by
 * DownloadWorker.episodeFilename for an episode — never re-derived here, so the
 * index and the disk can't disagree.
 *
 ...
 * is what the settings screen totals and what makes eviction decisions honest.
 *
...
data class DownloadEntry(
    ...
    companion object {
        ...
        /**
         * One path component this app is willing to create: `[A-Za-z0-9._-]`
