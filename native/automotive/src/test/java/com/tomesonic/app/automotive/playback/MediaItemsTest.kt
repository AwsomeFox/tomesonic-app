 ...
 * every ChapterMath mapping — the car's scrubber, the chapter title, the
 * syncer's position — silently point at the wrong part of the book.
 *
...
class MediaItemsTest {
    ...
    fun streamedItemsCarryTheBookTitleAuthorAndCover() {
        // The BOOK, not the track: this is what the car's now-playing screen and
        // every connected controller display, and a per-track title would make
        // the head unit read "Track 3".
