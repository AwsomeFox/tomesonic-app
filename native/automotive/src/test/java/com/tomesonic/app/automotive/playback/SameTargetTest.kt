...
class SameTargetTest {
    ...
    fun aBlankEpisodeIdMeansTheBook() {
        ...
        // land on the same answer or the guard depends on which caller asked.
    ...
    fun theItemAloneDoesNotMatchWhileOneOfItsEpisodesPlays() {
        // Asking for the PODCAST while an episode plays is a real switch (a
        // play on the item's own browse row means "play this item"), not a
        // re-tap.
