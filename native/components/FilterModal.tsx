...
// The encoder lives in utils/filters so non-UI modules (utils/shelfLayout)
// can share it without importing this component. Re-exported here so existing
// consumers keep their import path.
import { encodeFilterValue } from "../utils/filters";
export { encodeFilterValue };
