<template>
  <div class="w-full h-full" :style="contentPaddingStyle">
    ...
    <div class="flex items-center justify-center pt-4 fixed bottom-4 left-0 right-0">
      <a href="https://github.com/AwsomeFox/audiobookshelf-app" target="_blank" class="text-body-medium pr-2">{{ $strings.MessageFollowTheProjectOnGithub }}</a>
      <a href="https://github.com/AwsomeFox/audiobookshelf-app" target="_blank"
