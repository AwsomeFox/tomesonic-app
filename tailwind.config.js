...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        // Material 3 recommends system fonts for better performance
        sans: ['Roboto', 'system-ui', '-apple-system', 'sans-serif', ...defaultTheme.fontFamily.sans],
        mono: ['Roboto Mono', 'Ubuntu Mono', ...defaultTheme.fontFamily.mono]
      },
      fontSize: {
